...
int MetadataDecodePacketL4(uint8_t *ptr, metadata_to_suri_t *metadata_to_suri, metadata_to_suri_help_t *metadata_to_suri_help,
        uint8_t proto, size_t len, uint16_t size)
{
    int ret = 0;
